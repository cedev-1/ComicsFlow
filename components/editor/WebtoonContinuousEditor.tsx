            ...
            <div key={section.id} className="relative">
              ...
              <div
                ...
                onDrop={(e) => {
                  ...
                  if (!isNaN(fromIndex)) {
                    handleReorderSections(fromIndex, index);
                  }
                ...
                className={`w-full p-2 rounded border text-left transition-colors cursor-grab active:cursor-grabbing ${
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    {/* Drag handle */}
                    <svg className="w-3 h-3 text-[var(--text-tertiary)] flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
